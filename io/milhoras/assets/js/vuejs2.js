const app = new Vue ({
    ...
    data: {
        ...
        fechaValida: 'VÁLIDO DEL 28 DE SEPTIEMBRE AL 04 DE OCTUBRE',
        fechaValida2: 'VÁLIDO DEL 28 DE SEPTIEMBRE AL 04 DE OCTUBRE'

    },
    created(){
        var _this = this;
        this.JsonCategoryProduct2('VESTUARIO')
        $.getJSON("https://inoutlet.pe/milrespaldo/assets/data/days2.json", function(data){
            // console.log(data)
        ...
        $.getJSON("https://inoutlet.pe/milrespaldo/assets/data/all2.json", function(data){
            // console.log(data)

    ...
    created(){
        ...
        $.getJSON("assets/data/all.json", function(data){
            ...
            _this.productsAll = data.filter(product => {
                if ((product.publish === true && product.semana === '1')  ){
                    return true
                }
            })
            setTimeout(function(){ 
        ...
        $.getJSON("assets/data/all.json", function(data){
            _this.productsCategory = data.filter(product => {
                if ((product.publish === true && product.category === "CALZADO" && product.semana === '1'  )){
                    return true
                }
            });
            // console.log("ok");
        ...
        JsonCategoryProduct2: function(category){
            ...
            $.getJSON("assets/data/all.json", function(data){
                ...
                _this.productsCategory2 = data.filter(product => {
                    if ((product.publish === true && product.category === category && product.semana === '1'  )){
                        return true
                    }
                });
                // console.log("ok");

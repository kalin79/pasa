<template>
    <div>
        <section v-if="1===2">
            <div class="sectionCarousel" id="DaysCarrusel">
                <div class="container">
                    <div class="row">
                        <div class="col-1"></div>
                        <div class="col-10">
                            ...
                            <div class="header-titular d-flex justify-content-center">
                                <div class="box-subtitle">
                                    <h2 class="txt-blue2">{{ fechaValida2 }}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-1"></div>
                    ...
                    <div class="row">
                        <div class="col-1"></div>
                        <div class="col-10">
                            <div class="owl-carousel owl-theme owl-days owl-carouselSection">
                                
                                

                               <div v-for="(item, index) in productsDays" :key="index">
                                    <div class="card cardCont" v-if="item.plantilla == '1'">
                                        <div class="cardBack bgazul">
                                            <div class="card-body back">
                                                <div class="d-flex justify-content-center align-items-center height100">
                                                    <p class="txt-greenlight">
                                                        {{ item.legal }}
                                                    </p>
                                                </div>
                                            </div>
                                            <picture class="sombra">
                                                <source srcset="/assets/images/ofertas/sombra.png">
                                                <img srcset="/assets/images/ofertas/sombra.png" alt="sombra">
                                            </picture>
                                        </div>
                                        <div class="cardFront bgazul">
                                            <div class="d-flex justify-content-end box-logo">
                                                <img :src="item.logoB" class="img-card" :alt="item.nombre">
                                            </div>
                                            <div class="card-body">
                                                <div class="d-flex justify-content-start" v-if="item.disclaimer1 != ''">
                                                    <h2 class="txt-greenlight">{{ item.disclaimer1 }}</h2>
                                                </div>
                                                <div class="d-flex justify-content-center" v-if="item.disclaimer1 == ''">
                                                    <h3 class="txt-greenlight" v-if="item.subtitulo != 'MODELO2'">{{ item.porcentaje }} <span class="txt-greenlight">%</span></h3>
                                                    <h3 class="txt-greenlight" v-else>{{ item.porcentaje }}</h3>
                                                </div>
                                                <div class="d-flex justify-content-center" v-else>
                                                    <h3 class="txt-greenlight min" style="line-height: 0.75em">{{ item.porcentaje }} <span class="txt-greenlight">%</span></h3>
                                                </div>
                                                <div class="separate-card" v-if="item.disclaimer1 != ''"></div>
                                                <div class="d-flex justify-content-center " v-if="item.disclaimer2 != ''">
                                                    <div class="box-descripcion bggreen-light txt-blue">{{ item.disclaimer2 }}</div>
                                                </div>
                                            </div>

                                            <div class="card-footer">
                                                <div class="d-flex justify-content-end">
                                                    <a href="javascript:void(0)" class="txt-white">Ver legal</a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card cardCont" v-if="item.plantilla == '3'">
                                        <div class="cardBack bgazul">
                                            <div class="card-body back">
                                                <div class="d-flex justify-content-center align-items-center height100">
                                                    <p class="txt-greenlight">
                                        ...
                                        <div class="cardFront bgazul">
                                            ...
                                            <div class="card-body cardOpt3">
                                                <div class="d-flex justify-content-start">
                                                    <h2 class="txt-greenlight" v-if="item.disclaimer1 != '' ">{{ item.disclaimer1 }}</h2>
                                                    <h2 class="txt-greenlight" v-else style="opacity: 0;">DESDE</h2>
                                                </div>
                                                <div class="d-flex justify-content-center">
                                                    <h3 class="txt-greenlight d-flex justify-content-center align-items-start"><span class="moneda txt-greenlight">S/.</span>{{ item.precio }} <span class="txt-greenlight decimales">{{ item.preciodecimal }}</span></h3>
                                                </div>
                                                <div class="separate-card"></div>
                                                <div class="d-flex justify-content-center">
                                                    <div class="box-descripcion bggreen-light txt-blue">
                                                        {{ item.disclaimer2 }}
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card cardCont" v-if="item.plantilla == '2'">
                                        <div class="cardBack bgazul">
                                            <div class="card-body back">
                                                <div class="d-flex justify-content-center align-items-center height100">
                                                    <p class="txt-greenlight">
                                        ...
                                        <div class="cardFront bgazul">
                                            ...
                                            <div class="card-body cardOpt2">
                                                <div class="d-flex justify-content-center">
                                                    <div class="card-content">
                                                        <p class="txt-greenlight">{{ item.disclaimer1 }}</p>
                                                        <h4 class="txt-greenlight">{{ item.texto }}</h4>
                                                        <div class="separate-text"></div>
                                                        <div class="box-descripcion bggreen-light txt-blue">
                                                            {{ item.disclaimer2 }}
                                                        </div>
                                                        <p class="footer-text txt-greenlight">{{ item.disclaimer3 }} </p>
                                                    </div>
                                                </div>
            ...
            <div class="box-days">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-10">
                            <div class="header-titular d-flex justify-content-center">
                                <div class="linea pos1 flotante bgmelon"></div>
                                <div class="box-title bggreen">
                                    <h2 class="txt-white">PROMO TODOS LOS DÍAS</h2>
                                </div>
                                <div class="linea pos2 flotante bgmelon"></div>
                            </div>
                            <div class="header-titular d-flex justify-content-center">
                                <div class="box-subtitle ">
                                    <h2 class="txt-green">{{ fechaValida }}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-1"></div>
                    ...
                    <div class="row">
                        <div class="col-1"></div>
                        <div class="col-10">
                            <div class="owl-carousel owl-theme owl-fulldays owl-carouselSection">
                                    <div v-for="(item, index) in productsAll" :key="index">
                                        <div class="card cardCont" v-if="item.plantilla == '1'">
                                            <div class="cardBack bggreen">
                                                <div class="card-body back">
                                                    <div class="d-flex justify-content-center align-items-center height100">
                                                        <p class="txt-white">
                                                            {{ item.legal }}
                                            ...
                                            <div class="cardFront bggreen">
                                                <div class="d-flex justify-content-end box-logo">
                                                    <img :src="item.logo" class="img-card" :alt="item.nombre">
                                                </div>
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-start" v-if="item.disclaimer1 != ''">
                                                        <h2 class="txt-white">{{ item.disclaimer1 }}</h2>
                                                    </div>
                                                    <div class="d-flex justify-content-center" v-if="item.disclaimer1 == ''">
                                                        <h3 class="txt-white" v-if="item.subtitulo != 'MODELO2'">{{ item.porcentaje }} <span class="txt-white">%</span></h3>
                                                        <h3 class="txt-white" v-else>{{ item.porcentaje }}</h3>
                                                        <!-- <h3 class="txt-white">{{ item.porcentaje }}</h3> -->
                                                    </div>
                                                    <div class="d-flex justify-content-center" v-else>
                                                        <h3 class="txt-white min" style="line-height: 0.75em">{{ item.porcentaje }} <span class="txt-white">%</span></h3>
                                                    </div>
                                                    <div class="separate-card" v-if="item.disclaimer1 != ''"></div>
                                                    <div class="d-flex justify-content-center">
                                                        <div class="box-descripcion bgazul">{{ item.disclaimer2 }}</div>
                                                    </div>
                                                </div>

                                                <div class="card-footer">
                                                    <div class="d-flex justify-content-end">
                                                        <a href="javascript:void(0)" class="txt-blue">Ver legal</a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card cardCont" v-if="item.plantilla == '3'">
                                            ...
                                            <div class="cardFront bggreen">
                                                ...
                                                <div class="card-body cardOpt3">
                                                    <div class="d-flex justify-content-start">
                                                        <h2 class="txt-white" v-if="item.disclaimer1 != '' ">{{ item.disclaimer1 }}</h2>
                                                        <h2 class="txt-white" v-else style="opacity: 0;">DESDE</h2>

                                                    </div>
                                                    <div class="d-flex justify-content-center">
                                                        <h3 class="txt-white d-flex justify-content-center align-items-start"><span class="moneda txt-white">S/.</span>{{ item.precio }} <span class="txt-white decimales">{{ item.preciodecimal }}</span></h3>
                                                    </div>
                                                    <div class="separate-card"></div>
                                                    <div class="d-flex justify-content-center">
                                                        <div class="box-descripcion bgazul">
                                                            {{ item.disclaimer2 }}
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card cardCont" v-if="item.plantilla == '2'">
                                            ...
                                            <div class="cardFront bggreen">
                                                ...
                                                <div class="card-body cardOpt2">
                                                    <div class="d-flex justify-content-center">
                                                        <div class="card-content">
                                                            <p class="txt-white">{{ item.disclaimer1 }}</p>
                                                            <h4 class="txt-white">{{ item.texto }}</h4>
                                                            <div class="separate-text"></div>
                                                            <div class="box-descripcion bgazul">
                                                                {{ item.disclaimer2 }}
                                                            </div>
                                                            <p class="footer-text txt-blue2">{{ item.disclaimer3 }}</p>
                                                        </div>
                                                    </div>
        ...
        <!-- <div class="bannerFot">
            <div class="container">
                <a href="#">
                    <img src="/assets/images/ofertas/b111.png" alt="Banner" class="bannerFull">
                </a>
            </div>
        </div>
        <div class="separate-section"></div> -->
        ...
        <section class="borderMorado" id="CarroselCategoria">
                
            <div class="box-days carousel-movil">
                <!-- <div class="wrapper-blue"></div> -->
                <div class="container">
                    <div class="row">
                        <div class="col-1"></div>
                        <div class="col-10">
                            <div class="header-titular d-flex justify-content-center">
                                <div class="linea pos1 flotante celeste"></div>
                                <div class="box-title bgceleste">
                                    <h2 class="txt-bluelight">{{ nameCategory }}</h2>
                                </div>
                                <div class="linea pos2 flotante celeste"></div>
                            </div>
                    ...
                    <div class="separate-row2"></div>
                    <div class="row">
                        <div class="col-1"></div>
                        <div class="col-10">
                            <div class="owl-carousel owl-theme owl-categories2 owl-carouselSection">
                                <div v-for="(item, index) in productsCategory2" :key="index">
                                    <div class="card cardCont" v-if="item.plantilla == '1'">
                                        <div class="cardBack bgazul">
                                            <div class="card-body back">
                                                <div class="d-flex justify-content-center align-items-center height100">
            ...
            <div class="box-days carousel-desktop">
                <!-- <div class="wrapper-blue"></div> -->
                <div class="container">
                    <div>
                        <div class="row">
                            ...
                            <div class="col-10">
                                <div class="header-titular d-flex justify-content-center">
                                    <div class="linea pos1 flotante bgceleste"></div>
                                    <div class="box-title bgceleste">
                                        <h2 class="txt-bluelight">{{ nameCategory }}</h2>
                                    </div>
                                    <div class="linea pos2 flotante bgceleste"></div>
                                </div>
                            </div>
                            <div class="col-1"></div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-1"></div>
                            <div class="col-10">
                                <div class="owl-carousel owl-theme owl-categories owl-carouselSection">
                                    <!-- Inicio slider   -->
                                    <div v-for="(page, index) in productFilterCat" :key="index">
                                        <!-- {{ page }} -->
                                        <div class="d-flex justify-content-between align-items-center" >
                                            <!-- {{ page[0] }} -->
                                            <div class="boxOfert" v-if="page[0]"> 
                                                <div class="card cardCont card2" v-if="page[0].plantilla == '1'">
                                                    <div class="cardBack bgazul">
                                                        <div class="card-body back">
                                                            <div class="d-flex justify-content-center align-items-center height100">
                                                                <p class="txt-greenlight">
                                                    ...
                                                    <div class="cardFront bgazul">
                                                        <div class="d-flex justify-content-end box-logo">
                                                            <img :src="page[0].logoB" class="img-card" :alt="page[0].nombre">
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="d-flex justify-content-start" v-if="page[0].disclaimer1 != ''">
                                                                <h2 class="txt-greenlight">{{ page[0].disclaimer1 }}</h2>
                                                            </div>
                                                            <div class="d-flex justify-content-center" v-if="page[0].disclaimer1 == ''">
                                                                <h3 class="txt-greenlight" v-if="page[0].subtitulo != 'MODELO2'">{{ page[0].porcentaje }} <span class="txt-greenlight">%</span></h3>
                                                                <h3 class="txt-greenlight" v-else>{{ page[0].porcentaje }}</h3>
                                                            </div>
                                                            <div class="d-flex justify-content-center" v-else>
                                                                <h3 class="txt-greenlight min" style="line-height: 0.75em">{{ page[0].porcentaje }} <span class="txt-greenlight">%</span></h3>
                                                            </div>
                                                            <div class="separate-card" v-if="page[0].disclaimer1 != ''"></div>
                                                            <div class="d-flex justify-content-center">
                                                                <div class="box-descripcion bggreen-light txt-blue">{{ page[0].disclaimer2 }}</div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="card cardCont card2" v-if="page[0].plantilla == '3'">
                                                    <div class="cardBack bgazul">
                                                        <div class="card-body back">
                                                            <div class="d-flex justify-content-center align-items-center height100">
                                                                <p class="txt-greenlight">
                                                    ...
                                                    <div class="cardFront bgazul">
                                                        ...
                                                        <div class="card-body cardOpt3">
                                                            <div class="d-flex justify-content-start">
                                                                <h2 class="txt-greenlight" v-if="page[0].disclaimer1 != '' ">{{ page[0].disclaimer1 }}</h2>
                                                                <h2 class="txt-greenlight" v-else style="opacity: 0;">DESDE</h2>
                                                            </div>
                                                            <div class="d-flex justify-content-center">
                                                                <h3 class="txt-greenlight d-flex justify-content-center align-items-start"><span class="moneda txt-greenlight">S/.</span>{{ page[0].precio }} <span class="txt-greenlight decimales">{{ page[0].preciodecimal }}</span></h3>
                                                            </div>
                                                            <div class="separate-card"></div>
                                                            <div class="d-flex justify-content-center">
                                                                <div class="box-descripcion bggreen-light txt-blue">
                                                ...
                                                <div class="card cardCont card2" v-if="page[0].plantilla == '2'">
                                                    <div class="cardBack bgazul">
                                                        <div class="card-body back">
                                                            <div class="d-flex justify-content-center align-items-center height100">
                                                                <p class="txt-greenlight"> 
                                                    ...
                                                    <div class="cardFront bgazul">
                                                        ...
                                                        <div class="card-body cardOpt2">
                                                            <div class="d-flex justify-content-center">
                                                                <div class="card-content">
                                                                    <p class="txt-greenlight">{{ page[0].disclaimer1 }}</p>
                                                                    <h4 class="txt-greenlight">{{ page[0].texto }}</h4>
                                                                    <div class="separate-text"></div>
                                                                    <div class="box-descripcion bggreen-light txt-blue">
                                                                        {{ page[0].disclaimer2 }}
                                                                    </div>
                                                                    <p class="footer-text txt-greenlight">{{ page[0].disclaimer3 }} </p>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="card  boxOfert" v-else></div>
                                            
                                            <div class="separate-card2"></div>

                                            <div class="boxOfert" v-if="page[1]"> 
                                                <div class="card cardCont card2" v-if="page[1].plantilla == '1'">
                                                    <div class="cardBack bgazul">
                                                        <div class="card-body back">
                                                            <div class="d-flex justify-content-center align-items-center height100">
                                                                <p class="txt-greenlight">
                                                    ...
                                                    <div class="cardFront bgazul">
                                                        <div class="d-flex justify-content-end box-logo">
                                                            <img :src="page[1].logoB" class="img-card" :alt="page[1].nombre">
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="d-flex justify-content-start" v-if="page[1].disclaimer1 != ''">
                                                                <h2 class="txt-greenlight">{{ page[1].disclaimer1 }}</h2>
                                                            </div>
                                                            <div class="d-flex justify-content-center" v-if="page[1].disclaimer1 == ''">
                                                                <h3 class="txt-greenlight" v-if="page[1].subtitulo != 'MODELO2'">{{ page[1].porcentaje }} <span class="txt-greenlight">%</span></h3>
                                                                <h3 class="txt-greenlight" v-else>{{ page[1].porcentaje }} </h3>
                                                            </div>
                                                            <div class="d-flex justify-content-center" v-else>
                                                                <h3 class="txt-greenlight min" style="line-height: 0.75em">{{ page[1].porcentaje }} <span class="txt-greenlight">%</span></h3>
                                                            </div>
                                                            <div class="separate-card" v-if="page[1].disclaimer1 != ''"></div>
                                                            <div class="d-flex justify-content-center">
                                                                <div class="box-descripcion bggreen-light txt-blue">{{ page[1].disclaimer2 }}</div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="card cardCont card2" v-if="page[1].plantilla == '3'">
                                                    <div class="cardBack bgazul">
                                                        <div class="card-body back">
                                                            <div class="d-flex justify-content-center align-items-center height100">
                                                                <p class="txt-greenlight">
                                                    ...
                                                    <div class="cardFront bgazul">
                                                        ...
                                                        <div class="card-body cardOpt3">
                                                            <div class="d-flex justify-content-start">
                                                                <h2 class="txt-greenlight" v-if="page[1].disclaimer1 != '' ">{{ page[1].disclaimer1 }}</h2>
                                                                <h2 class="txt-greenlight" v-else style="opacity: 0;">DESDE</h2>
                                                            </div>
                                                            <div class="d-flex justify-content-center">
                                                                <h3 class="txt-greenlight d-flex justify-content-center align-items-start"><span class="moneda txt-greenlight">S/.</span>{{ page[1].precio }} <span class="txt-greenlight decimales">{{ page[1].preciodecimal }}</span></h3>
                                                            </div>
                                                            <div class="separate-card"></div>
                                                            <div class="d-flex justify-content-center">
                                                                <div class="box-descripcion bggreen-light txt-blue">
                                                ...
                                                <div class="card cardCont card2" v-if="page[1].plantilla == '2'">
                                                    <div class="cardBack bgazul">
                                                        <div class="card-body back">
                                                            <div class="d-flex justify-content-center align-items-center height100">
                                                                <p class="txt-greenlight"> 
                                                    ...
                                                    <div class="cardFront bgazul">
                                                        ...
                                                        <div class="card-body cardOpt2">
                                                            <div class="d-flex justify-content-center">
                                                                <div class="card-content">
                                                                    <p class="txt-greenlight">{{ page[1].disclaimer1 }}</p>
                                                                    <h4 class="txt-greenlight">{{ page[1].texto }}</h4>
                                                                    <div class="separate-text"></div>
                                                                    <div class="box-descripcion bggreen-light txt-blue">
                                                                        {{ page[1].disclaimer2 }}
                                                                    </div>
                                                                    <p class="footer-text txt-greenlight">{{ page[1].disclaimer3 }} </p>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="card  boxOfert" v-else></div>
                                            <div class="separate-card2"></div>
                                            <div class="boxOfert" v-if="page[2]"> 
                                                <div class="card cardCont card2" v-if="page[2].plantilla == '1'">
                                                    <div class="cardBack bgazul">
                                                        <div class="card-body back">
                                                            <div class="d-flex justify-content-center align-items-center height100">
                                                                <p class="txt-greenlight">
                                                    ...
                                                    <div class="cardFront bgazul">
                                                        <div class="d-flex justify-content-end box-logo">
                                                            <img :src="page[2].logoB" class="img-card" :alt="page[2].nombre">
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="d-flex justify-content-start" v-if="page[2].disclaimer1 != ''">
                                                                <h2 class="txt-greenlight">{{ page[2].disclaimer1 }}</h2>
                                                            </div>
                                                            <div class="d-flex justify-content-center" v-if="page[2].disclaimer1 == ''">
                                                                <h3 class="txt-greenlight" v-if="page[2].subtitulo != 'MODELO2'">{{ page[2].porcentaje }} <span class="txt-greenlight">%</span></h3>
                                                                <h3 class="txt-greenlight" v-else>{{ page[2].porcentaje }} </h3>
                                                            </div>
                                                            <div class="d-flex justify-content-center" v-else>
                                                                <h3 class="txt-greenlight min" style="line-height: 0.75em">{{ page[2].porcentaje }} <span class="txt-greenlight">%</span></h3>
                                                            </div>
                                                            <div class="separate-card" v-if="page[2].disclaimer1 != ''"></div>
                                                            <div class="d-flex justify-content-center">
                                                                <div class="box-descripcion bggreen-light txt-blue">{{ page[2].disclaimer2 }}</div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="card cardCont card2" v-if="page[2].plantilla == '3'">
                                                    <div class="cardBack bgazul">
                                                        <div class="card-body back">
                                                            <div class="d-flex justify-content-center align-items-center height100">
                                                                <p class="txt-greenlight">
                                                    ...
                                                    <div class="cardFront bgazul">
                                                        ...
                                                        <div class="card-body cardOpt3">
                                                            <div class="d-flex justify-content-start">
                                                                <h2 class="txt-greenlight" v-if="page[2].disclaimer1 != '' ">{{ page[2].disclaimer1 }}</h2>
                                                                <h2 class="txt-greenlight" v-else style="opacity: 0;">DESDE</h2>
                                                            </div>
                                                            <div class="d-flex justify-content-center">
                                                                <h3 class="txt-greenlight d-flex justify-content-center align-items-start"><span class="moneda txt-greenlight">S/.</span>{{ page[2].precio }} <span class="txt-greenlight decimales">{{ page[2].preciodecimal }}</span></h3>
                                                            </div>
                                                            <div class="separate-card"></div>
                                                            <div class="d-flex justify-content-center">
                                                                <div class="box-descripcion bggreen-light txt-blue">
                                                ...
                                                <div class="card cardCont card2" v-if="page[2].plantilla == '2'">
                                                    <div class="cardBack bgazul">
                                                        <div class="card-body back">
                                                            <div class="d-flex justify-content-center align-items-center height100">
                                                                <p class="txt-greenlight"> 
                                                    ...
                                                    <div class="cardFront bgazul">
                                                        ...
                                                        <div class="card-body cardOpt2">
                                                            <div class="d-flex justify-content-center">
                                                                <div class="card-content">
                                                                    <p class="txt-greenlight">{{ page[2].disclaimer1 }}</p>
                                                                    <h4 class="txt-greenlight">{{ page[2].texto }}</h4>
                                                                    <div class="separate-text"></div>
                                                                    <div class="box-descripcion bggreen-light txt-blue">
                                                                        {{ page[2].disclaimer2 }}
                                                                    </div>
                                                                    <p class="footer-text txt-greenlight">{{ page[2].disclaimer3 }} </p>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="separate-row3"></div>
                                        <div class="d-flex justify-content-between align-items-center" >
                                            
                                            <div class="boxOfert" v-if="page[3]"> 
                                                <div class="card cardCont card2" v-if="page[3].plantilla == '1'">
                                                    <div class="cardBack bgazul">
                                                        <div class="card-body back">
                                                            <div class="d-flex justify-content-center align-items-center height100">
                                                                <p class="txt-greenlight">
                                                    ...
                                                    <div class="cardFront bgazul">
                                                        <div class="d-flex justify-content-end box-logo">
                                                            <img :src="page[3].logoB" class="img-card" :alt="page[3].nombre">
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="d-flex justify-content-start" v-if="page[3].disclaimer1 != ''">
                                                                <h2 class="txt-greenlight">{{ page[3].disclaimer1 }}</h2>
                                                            </div>
                                                            <div class="d-flex justify-content-center" v-if="page[3].disclaimer1 == ''">
                                                                <h3 class="txt-greenlight" v-if="page[3].subtitulo != 'MODELO2'">{{ page[3].porcentaje }} <span class="txt-greenlight">%</span></h3>
                                                                <h3 class="txt-greenlight" v-else>{{ page[3].porcentaje }}</h3>
                                                            </div>
                                                            <div class="d-flex justify-content-center" v-else>
                                                                <h3 class="txt-greenlight min" style="line-height: 0.75em">{{ page[3].porcentaje }} <span class="txt-greenlight">%</span></h3>
                                                            </div>
                                                            <div class="separate-card" v-if="page[3].disclaimer1 != ''"></div>
                                                            <div class="d-flex justify-content-center">
                                                                <div class="box-descripcion bggreen-light txt-blue">{{ page[3].disclaimer2 }}</div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="card cardCont card2" v-if="page[3].plantilla == '3'">
                                                    <div class="cardBack bgazul">
                                                        <div class="card-body back">
                                                            <div class="d-flex justify-content-center align-items-center height100">
                                                                <p class="txt-greenlight">
                                                    ...
                                                    <div class="cardFront bgazul">
                                                        ...
                                                        <div class="card-body cardOpt3">
                                                            <div class="d-flex justify-content-start">
                                                                <h2 class="txt-greenlight" v-if="page[3].disclaimer1 != '' ">{{ page[3].disclaimer1 }}</h2>
                                                                <h2 class="txt-greenlight" v-else style="opacity: 0;">DESDE</h2>
                                                            </div>
                                                            <div class="d-flex justify-content-center">
                                                                <h3 class="txt-greenlight d-flex justify-content-center align-items-start"><span class="moneda txt-greenlight">S/.</span>{{ page[3].precio }} <span class="txt-greenlight decimales">{{ page[3].preciodecimal }}</span></h3>
                                                            </div>
                                                            <div class="separate-card"></div>
                                                            <div class="d-flex justify-content-center">
                                                                <div class="box-descripcion bggreen-light txt-blue">
                                                ...
                                                <div class="card cardCont card2" v-if="page[3].plantilla == '2'">
                                                    <div class="cardBack bgazul">
                                                        <div class="card-body back">
                                                            <div class="d-flex justify-content-center align-items-center height100">
                                                                <p class="txt-greenlight"> 
                                                    ...
                                                    <div class="cardFront bgazul">
                                                        ...
                                                        <div class="card-body cardOpt2">
                                                            <div class="d-flex justify-content-center">
                                                                <div class="card-content">
                                                                    <p class="txt-greenlight">{{ page[3].disclaimer1 }}</p>
                                                                    <h4 class="txt-greenlight">{{ page[3].texto }}</h4>
                                                                    <div class="separate-text"></div>
                                                                    <div class="box-descripcion bggreen-light txt-blue">
                                                                        {{ page[3].disclaimer2 }}
                                                                    </div>
                                                                    <p class="footer-text txt-greenlight">{{ page[3].disclaimer3 }} </p>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="boxOfert" v-if="page[4]"> 
                                                <div class="card cardCont card2" v-if="page[4].plantilla == '1'">
                                                    <div class="cardBack bgazul">
                                                        <div class="card-body back">
                                                            <div class="d-flex justify-content-center align-items-center height100">
                                                                <p class="txt-greenlight">
                                                    ...
                                                    <div class="cardFront bgazul">
                                                        <div class="d-flex justify-content-end box-logo">
                                                            <img :src="page[4].logoB" class="img-card" :alt="page[4].nombre">
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="d-flex justify-content-start" v-if="page[4].disclaimer1 != ''">
                                                                <h2 class="txt-greenlight">{{ page[4].disclaimer1 }}</h2>
                                                            </div>
                                                            <div class="d-flex justify-content-center" v-if="page[4].disclaimer1 == ''">
                                                                <h3 class="txt-greenlight" v-if="page[4].subtitulo != 'MODELO2'">{{ page[4].porcentaje }} <span class="txt-greenlight">%</span></h3>
                                                                <h3 class="txt-greenlight" v-else>{{ page[4].porcentaje }}</h3>
                                                            </div>
                                                            <div class="d-flex justify-content-center" v-else>
                                                                <h3 class="txt-greenlight min" style="line-height: 0.75em">{{ page[4].porcentaje }} <span class="txt-greenlight">%</span></h3>
                                                            </div>
                                                            <div class="separate-card" v-if="page[4].disclaimer1 != ''"></div>
                                                            <div class="d-flex justify-content-center">
                                                                <div class="box-descripcion bggreen-light txt-blue">{{ page[4].disclaimer2 }}</div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="card cardCont card2" v-if="page[4].plantilla == '3'">
                                                    <div class="cardBack bgazul">
                                                        <div class="card-body back">
                                                            <div class="d-flex justify-content-center align-items-center height100">
                                                                <p class="txt-greenlight">
                                                    ...
                                                    <div class="cardFront bgazul">
                                                        ...
                                                        <div class="card-body cardOpt3">
                                                            <div class="d-flex justify-content-start">
                                                                <h2 class="txt-greenlight" v-if="page[4].disclaimer1 != '' ">{{ page[4].disclaimer1 }}</h2>
                                                                <h2 class="txt-greenlight" v-else style="opacity: 0;">DESDE</h2>
                                                            </div>
                                                            <div class="d-flex justify-content-center">
                                                                <h3 class="txt-greenlight d-flex justify-content-center align-items-start"><span class="moneda txt-greenlight">S/.</span>{{ page[4].precio }} <span class="txt-greenlight decimales">{{ page[4].preciodecimal }}</span></h3>
                                                            </div>
                                                            <div class="separate-card"></div>
                                                            <div class="d-flex justify-content-center">
                                                                <div class="box-descripcion bggreen-light txt-blue">
                                                ...
                                                <div class="card cardCont card2" v-if="page[4].plantilla == '2'">
                                                    <div class="cardBack bgazul">
                                                        <div class="card-body back">
                                                            <div class="d-flex justify-content-center align-items-center height100">
                                                                <p class="txt-greenlight"> 
                                                    ...
                                                    <div class="cardFront bgazul">
                                                        ...
                                                        <div class="card-body cardOpt2">
                                                            <div class="d-flex justify-content-center">
                                                                <div class="card-content">
                                                                    <p class="txt-greenlight">{{ page[4].disclaimer1 }}</p>
                                                                    <h4 class="txt-greenlight">{{ page[4].texto }}</h4>
                                                                    <div class="separate-text"></div>
                                                                    <div class="box-descripcion bggreen-light txt-blue">
                                                                        {{ page[4].disclaimer2 }}
                                                                    </div>
                                                                    <p class="footer-text txt-greenlight">{{ page[4].disclaimer3 }} </p>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="card  boxOfert" v-else></div>
                                            <div class="separate-card2"></div>
                                            <div class="boxOfert" v-if="page[5]"> 
                                                <div class="card cardCont card2" v-if="page[5].plantilla == '1'">
                                                    <div class="cardBack bgazul">
                                                        <div class="card-body back">
                                                            <div class="d-flex justify-content-center align-items-center height100">
                                                                <p class="txt-greenlight">
                                                    ...
                                                    <div class="cardFront bgazul">
                                                        <div class="d-flex justify-content-end box-logo">
                                                            <img :src="page[5].logoB" class="img-card" :alt="page[5].nombre">
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="d-flex justify-content-start" v-if="page[5].disclaimer1 != ''">
                                                                <h2 class="txt-greenlight">{{ page[5].disclaimer1 }}</h2>
                                                            </div>
                                                            <div class="d-flex justify-content-center" v-if="page[5].disclaimer1 == ''">
                                                                <h3 class="txt-greenlight" v-if="page[5].subtitulo != 'MODELO2'">{{ page[5].porcentaje }} <span class="txt-greenlight">%</span></h3>
                                                                <h3 class="txt-greenlight" v-else>{{ page[5].porcentaje }}</h3>
                                                            </div>
                                                            <div class="d-flex justify-content-center" v-else>
                                                                <h3 class="txt-greenlight min" style="line-height: 0.75em">{{ page[5].porcentaje }} <span class="txt-greenlight">%</span></h3>
                                                            </div>
                                                            <div class="separate-card" v-if="page[5].disclaimer1 != ''"></div>
                                                            <div class="d-flex justify-content-center">
                                                                <div class="box-descripcion bggreen-light txt-blue">{{ page[5].disclaimer2 }}</div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="card cardCont card2" v-if="page[5].plantilla == '3'">
                                                    <div class="cardBack bgazul">
                                                        <div class="card-body back">
                                                            <div class="d-flex justify-content-center align-items-center height100">
                                                                <p class="txt-greenlight">
                                                    ...
                                                    <div class="cardFront bgazul">
                                                        ...
                                                        <div class="card-body cardOpt3">
                                                            <div class="d-flex justify-content-start">
                                                                <h2 class="txt-greenlight" v-if="page[5].disclaimer1 != '' ">{{ page[5].disclaimer1 }}</h2>
                                                                <h2 class="txt-greenlight" v-else style="opacity: 0;">DESDE</h2>
                                                            </div>
                                                            <div class="d-flex justify-content-center">
                                                                <h3 class="txt-greenlight d-flex justify-content-center align-items-start"><span class="moneda txt-greenlight">S/.</span>{{ page[5].precio }} <span class="txt-greenlight decimales">{{ page[5].preciodecimal }}</span></h3>
                                                            </div>
                                                            <div class="separate-card"></div>
                                                            <div class="d-flex justify-content-center">
                                                                <div class="box-descripcion bggreen-light txt-blue">
                                                ...
                                                <div class="card cardCont card2" v-if="page[5].plantilla == '2'">
                                                    <div class="cardBack bgazul">
                                                        <div class="card-body back">
                                                            <div class="d-flex justify-content-center align-items-center height100">
                                                                <p class="txt-greenlight"> 
                                                    ...
                                                    <div class="cardFront bgazul">
                                                        ...
                                                        <div class="card-body cardOpt2">
                                                            <div class="d-flex justify-content-center">
                                                                <div class="card-content">
                                                                    <p class="txt-greenlight">{{ page[5].disclaimer1 }}</p>
                                                                    <h4 class="txt-greenlight">{{ page[5].texto }}</h4>
                                                                    <div class="separate-text"></div>
                                                                    <div class="box-descripcion bggreen-light txt-blue">
                                                                        {{ page[5].disclaimer2 }}
                                                                    </div>
                                                                    <p class="footer-text txt-greenlight">{{ page[5].disclaimer3 }} </p>
                                                                </div>
                                                            </div>
        ...
        <div class="bannerFot">
            <div class="container">
                <a href="#">
                    <img src="/assets/images/ofertas/yape.jpg" alt="Banner" class="bannerFull">
                </a>
            </div>
        </div>
                ...
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <div class="social social-footer" >
                            <div class="d-flex">
                                <a href="http://www.facebook.com/115253295184913" target="_blank" alt="El Quinde en Facebook">
                    ...
                    <a style="color: #3f4358" target="_blank" href="https://inoutlet.pe/terminos-condiciones/?camp=milhorasdelocura">Términos y condiciones</a>
                    <div>El Quinde :: Cajamarca Perú 2020</div>
                </div>

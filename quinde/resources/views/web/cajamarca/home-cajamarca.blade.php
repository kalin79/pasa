...
@section('meta')
    <title>INICIO | C.C El Quinde Shopping Plaza Cajamarca</title>
...
<style>
    ...
    <main class="main">
        <div class="box-button">
            <a href="https://www.elquinde.pe/juntosnosprotegemos-locatarios" id="btn-cajamarca-home-juntos-locatarios">
                ¿Tienes <br>
                un local con <br>
                nosotros? <br>
                Haz Click <br>
            ...
            <div class="card-section-home mt-5">
                ...
                <div class="card-section-home__data wow bounceInLeft bg-color7">
                    <div class="content-title xs-center">
                        ...
                        <a class="btn btn--theme3 card-content__link mt-3" href="{{url('cajamarca/tiendas')}}">Conócelas aquí</a>
                    </div>
                </div>
            </div>
            <div class="card-section-home mt-5">
                ...
                <div class="card-section-home__data wow bounceInLeft bg-color5">
                    <div class="content-title xs-center">
                        ...
                        <a class="btn btn--theme3 card-content__link mt-3" href="{{url('cajamarca/promociones')}}">Conócelas aquí</a>
                    </div>
                </div>
            </div>
            <div class="card-section-home mt-5 mb-5">
                ...
                <div class="card-section-home__data wow bounceInLeft bg-color3">
                    <div class="content-title xs-center">
                        ...
                        <a class="btn btn--theme3 card-content__link mt-3" href="{{url('cajamarca/eventos')}}">Conócelos aquí</a>
                    </div>
        ...
        <section class="section home-billboard bg-grey-color max-1920">
            <div class="container pd-bill">
                ...
                <div class="xs-center"><a class="btn btn--theme3" href="{{url('cajamarca/carteleras')}}">REVÍSALA AQUÍ</a></div>
            </div>
   ...
   <!-- <main class="main">
        ...
        <section class="section home-sections" id="home-section">
            <div class="card-home">
                <div class="card-home__image wow bounceInRight">
                    <div class="bg-image" style="background-image: url('{{asset('assets/images/storage/section-home-1.jpg')}}')"></div>
                </div>
                <div class="card-home__data box-card-home box-card-home-stores bg-color7 wow bounceInLeft">
                    ...
                    <div class="card-content">
                        ...
                        </h3><a class="btn btn--theme3 card-content__link" href="{{url('cajamarca/tiendas')}}">Conócelas aquí</a>
                    </div>
            ...
            <div class="card-home">
                ...
                <div class="card-home__data card-home__data box-card-home box-card-home-prom wow bounceInLeft bg-color5">
                    <div class="card-content">
                        ...
                        </h3><a class="btn btn--theme3 card-content__link" href="{{url('cajamarca/promociones')}}">Conócelas aquí</a>
                    </div>
            ...
            <div class="card-home">
                ...
                <div class="card-home__data card-home__data box-card-home box-card-home-events wow bounceInLeft bg-color3">
                    <div class="card-content">
                        <h3 class="section__title color4">
                            <div class="about-leafs-left"></div> Eventos<div class="about-leafs-right"></div>
                        </h3><a class="btn btn--theme3 card-content__link" href="{{url('cajamarca/eventos')}}">Conócelos</a>
                    </div>
        ...
        <section class="section home-billboard bg-grey-color max-1920">
            <div class="container pd-bill">
                ...
                <div class="xs-center"><a class="btn btn--theme3" href="{{url('cajamarca/carteleras')}}"> REVÍSALA AQUI</a></div>
            </div>
            <div class="bg-home-bottom bg-home-bottom-footer"></div>
        </section>
    </main><span class="line-bar"></span>-->

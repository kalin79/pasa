...
@section('meta')
    <title>SUSCRÍBETE | C.C El Quinde Shopping Plaza Cajamarca</title>
                    ...
                    <div class="col-xl-10 col-xxxl-9 xs-m-auto">
                        ...
                        <form class="suscribete-form mt-5" id="suscribete_form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 form-group mt-4"><label class="label-theme mb-3">Celular:</label><input class="form-control input-theme validate" type="text" maxlength="9" name="celular"><label class="messages">Ingresar Celular</label></div>
                            </div>
                            <div class="row">

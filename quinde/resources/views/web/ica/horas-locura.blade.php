...
<head>
    ...
    <title>El Quinde Ica - Centro Comercial :: Mil horas de Locuras</title>
    <link rel="stylesheet" href="https://inoutlet.pe/juntosnosprotegemos/node_modules/bootstrap/dist/css/bootstrap.min.css" >
    <link rel="stylesheet" href="https://inoutlet.pe/juntosnosprotegemos/node_modules/owl.carousel/dist/assets/owl.carousel.min.css" />
    <link rel="stylesheet" href="https://inoutlet.pe/juntosnosprotegemos/node_modules/owl.carousel/dist/assets/owl.theme.default.min.css" />
   
    <link rel="stylesheet" href="https://allyoucan.cloud/cdn/icofont/1.0.1/icofont.css">

    <link rel="stylesheet" href="{{asset('css/fonts/akrobat/fonts.css?0f39fc1c10353f1a03ac')}}" >
    <link rel="stylesheet" href="{{asset('css/fonts/gotha/fonts.css?0f39fc1c10353f1a03ac')}}" >
    <link rel="stylesheet" href="{{asset('css/fonts/archer/fonts.css?0f39fc1c10353f1a03ac')}}" >
    <link rel="stylesheet" href="{{asset('css/fonts/mont/fonts.css?0f39fc1c10353f1a03ac')}}" >
    <link rel="stylesheet" href="{{asset('css/fonts/montB/fonts.css?0f39fc1c10353f1a03ac')}}" >
    <link rel="stylesheet" href="{{asset('css/ofertas.css?0f39fc1c10353f1a03ac')}}" >
...
<script type='text/javascript'>
    ...
    <header id=headerMain>
        <div class="container">
            <div class="d-flex relative justify-content-between d-flex align-items-center">
                <div></div>
                <a href="https://www.elquinde.pe/ica" class="logoMain">
                    <picture>
                        <source srcset="{{asset('assets/images/ofertas/logo.png')}}">
                        <img srcset="{{asset('assets/images/ofertas/logo.png')}}" alt="Larcomar">
                    </picture>
                </a>
                <div class="d-flex justify-content-start align-items-center">
                    ...
                    <button type="button" class="btn btn-primary" id="btn-suscripcion">Suscríbete aquí</button>
                    <!-- <div class="box-sede">
                        <a href="/cajamarca/milhorasdelocura">
    ...
    <div class="Slidermain" id="BannerMain">
        <div class="owl-carousel owl-theme owl-banner">
            <div>
                <div class="bannerMain">
                    <div class="container">
                        <picture class="box-esfera flotante">
                            <source srcset="{{asset('assets/images/ofertas/esfera.png')}}">
                            <img srcset="{{asset('assets/images/ofertas/esfera.png')}}" alt="esfera">
                        </picture>
                        <picture class="box-raqueta flotante">
                            <source srcset="{{asset('assets/images/ofertas/raqueta.png')}}">
                            <img srcset="{{asset('assets/images/ofertas/raqueta.png')}}" alt="raqueta">
                        </picture>
                        <picture class="box-bolsa flotante">
                            <source srcset="{{asset('assets/images/ofertas/bolsa.png')}}">
                            <img srcset="{{asset('assets/images/ofertas/bolsa.png')}}" alt="bolsa">
                        </picture>
                        <picture class="box-bici flotante">
                            <source srcset="{{asset('assets/images/ofertas/bici.png')}}">
                            <img srcset="{{asset('assets/images/ofertas/bici.png')}}" alt="bici">
                        </picture>
                        <picture class="box-bolsaabierta flotante">
                            <source srcset="{{asset('assets/images/ofertas/bolsa-abierta.png')}}">
                            <img srcset="{{asset('assets/images/ofertas/bolsa-abierta.png')}}" alt="bolsaabierta">
                        </picture>
                        <picture class="box-esfera2 flotante">
                            <source srcset="{{asset('assets/images/ofertas/esfera2.png')}}">
                            <img srcset="{{asset('assets/images/ofertas/esfera2.png')}}" alt="esfera">
                        </picture>
                        <div class="inner-container d-flex justify-content-center flex-column">
                            <div class="box-reloj">
                                <div id="pictureReloj">
                                    <picture class="pictureReloj" >
                                        <source srcset="{{asset('assets/images/ofertas/t_b1.png')}}" media="(min-width: 992px)">
                                        <source srcset="{{asset('assets/images/ofertas/t_b1-movil.png')}}">
                                        <img srcset="{{asset('assets/images/ofertas/t_b1-movil.png')}}" alt="reloj">
                                    </picture>
                                </div>
                            ...
                            <div class="box-title">
                                <h2>¡DE LOCURA!</h2>
                                <h1>Las mejores ofertas en las mejores marcas</h1>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container inner-container">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-5">
                                <h3>
                                    ¿No pagar <br>
                                    intereses por las <br>
                                    compras de tu <br>
                                    Tarjeta de Crédito?
                                </h3>
                                <a href="" class="btn btn-success" target="_blank">AQUÍ</a>
                            </div>
                            <div class="col-12 col-md-4">
                                <picture class="img-tarjeta">
                                    <source srcset="{{asset('assets/images/ofertas/tarjeta.png')}}">
                                    <img srcset="{{asset('assets/images/ofertas/tarjeta.png')}}" alt="BBVA">
                                </picture>
                            </div>
    ...
    <section>
        <div class="box-days-desktop posTop1" >
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-10">
                        <div class="header-titular d-flex justify-content-center">
                            <div class="linea pos1 flotante bgyellowLight"></div>
                            <div class="box-title bggreen ">
                                <h2 class="t-white">DíaS LOCOS</h2>
                            </div>
                            <div class="linea pos2 flotante bgyellowLight"></div>
                        </div>
                        <div class="header-titular d-flex justify-content-center">
                            <div class="box-subtitle">
                                <h2 class="t-green">Válido de xx al xx de agosto</h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-1"></div>
                ...
                <div class="row">
                    <div class="col-1"></div>
                    <div class="col-10">
                        <div class="owl-carousel owl-theme owl-days">
                            <div class="d-flex justify-content-between">
                                <div class="card bgyellowLight">
                                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                                    <div class="card-body">
                                        <h5 class="card-title t-green">TELEVISOR <br>55’’</h5>
                                        <!-- <a href="#" class="btn btn-primary">Hasta agotar stock</a> -->
                                        <p class="white">
                                            Hasta 50% de dscto en productos seleccionados. <br>
                                            Hasta agotar stock
                                        </p>
                                    </div>
                                    <picture class="sombra">
                                        <source srcset="{{asset('assets/images/ofertas/sombra.png')}}">
                                        <img srcset="{{asset('assets/images/ofertas/sombra.png')}}" alt="sombra">
                                    </picture>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between">
                                <div class="card bgpurple">
                                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                                    <div class="card-body">
                                        <h5 class="card-title t-white">PlayStation <br>SLIM 5</h5>
                                        <p class="white">
                                            Hasta 50% de dscto en productos seleccionados. <br>
                                            Hasta agotar stock
                                        </p>
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="card bgyellowLight">
                                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                                    <div class="card-body">
                                        <h5 class="card-title t-green">MOCHILA <br>PORTA</h5>
                                        <p class="white">
                                            Hasta 50% de dscto en productos seleccionados. <br>
                                            Hasta agotar stock
                                        </p>
        ...
        <div class="box-days posTop">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-10">
                        <div class="header-titular d-flex justify-content-center">
                            <div class="linea pos1 flotante bgblack"></div>
                            <div class="box-title">
                                <h2 class="t-green">DíaS LOCOS</h2>
                            </div>
                            <div class="linea pos2 flotante bgblack"></div>
                        </div>
                        <div class="header-titular d-flex justify-content-center">
                            <div class="box-subtitle">
                                <h2 class="t-yellow2">Válido de xx al xx de agosto</h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-1"></div>
                        ...
                        <div class="owl-carousel owl-theme owl-days">
                            <div class="d-flex justify-content-between">
                                <div class="card cardCont">
                                    <div class="cardBack bgyellowLight">
                                    ...
                                    <div class="cardFront bgyellowLight">
                                        <!-- <img src="..." class="card-img-top" alt="..."> -->
                                        <div class="card-body">
                                            <h5 class="card-title t-green">TELEVISOR <br>55’’</h5>
                                            <!-- <a href="#" class="btn btn-primary">Hasta agotar stock</a> -->
    ...
    <section>
        <div class="box-days-desktop posTop4">
            <!-- <div class="wrapper-blue"></div> -->
            <div class="container">
                <div class="row">
                    <div class="col-1"></div>
                    <div class="col-10">
                        <div class="header-titular d-flex justify-content-center">
                            <div class="linea pos1 flotante bgyellowLight"></div>
                            <div class="box-title bggreen">
                                <h2 class="t-white">PROMO TODOS LOS DÍAS</h2>
                            </div>
                            <div class="linea pos2 flotante bgyellowLight"></div>
                        </div>
                        <div class="header-titular d-flex justify-content-center">
                ...
                <div class="row">
                    <div class="col-1"></div>
                    <div class="col-10">
                        <div class="owl-carousel owl-theme owl-fulldays">
                            <div class="d-flex justify-content-between">
                                <div class="card bggreen borderPurpleDark p1">
                                    <div class="d-flex justify-content-end">
                                        <img src="{{asset('assets/images/ofertas/logo1.png')}}" class="img-card" alt="logo">
                                    </div>
                                    <div class="card-body left white">
                                        <h5 class="card-title small">hasta <br><span>50%</span></h5>
                                        <!-- <a href="#" class="btn btn-primary">Hasta agotar stock</a> -->
                                        <p>
                                            Hasta 50% de dscto en productos seleccionados. <br>
                                            Hasta agotar stock
                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        <div class="owl-carousel owl-theme owl-fulldays">
                            <div class="d-flex justify-content-between">
                                <div class="card  cardCont">
                                    <div class="cardBack borderPurpleDark bggreen">
                                        <div class="card-body back">
                                            <p class="t-black">
                                                Hasta 50% de dscto en productos seleccionados. <br>
                                                Hasta agotar stock
                                    ...
                                    <div class="cardFront borderPurpleDark bggreen p1">
                                        <div class="d-flex justify-content-end">
                                            <img src="{{asset('assets/images/ofertas/logo1.png')}}" class="img-card" alt="logo">
                                        </div>
                                        <div class="card-body left white">
    ...
    <div class="bannerMed">
        <div class="container">
            <a href="#">
                <img src="{{asset('assets/images/ofertas/banner1.jpg')}}" alt="Banner">
            </a>
        </div>
    </div>
    ...
    <nav>
        <div class="header-titular d-flex justify-content-center">
            <div class="box-title bgblue">
                <h2 class="t-white">CATEGORÍAS</h2>
            </div>
        </div>
        <div class="container">
    ...
    <section>
        <div class="box-days-desktop posTop3">
            <!-- <div class="wrapper-blue"></div> -->
            <div class="container">
                <div class="row">
                    <div class="col-1"></div>
                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        <div class="owl-carousel owl-theme owl-categories">
                            ...
                            <div class="card bgyellowLight borderPurpleDark p1">
                                <div class="d-flex justify-content-end">
                                    <img src="{{asset('assets/images/ofertas/logo2.png')}}" class="img-card" alt="logo">
                                </div>
                                <div class="card-body left green2">
                                    <h5 class="card-title small">hasta <br><span>50%</span></h5>
                                    <!-- <a href="#" class="btn btn-primary">Hasta agotar stock</a> -->
                                    <h3 class="t-green">
                                        EN PRODUCTOS <br>
                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        <div class="owl-carousel owl-theme owl-categories">
                            <div>
                                <div class="d-flex justify-content-between">
                                    <div class="card cardCont h2">
                                        <div class="cardBack bgyellowLight borderPurple">
                                            <div class="card-body back">
                                                <p class="t-black">
                                                    Hasta 50% de dscto en productos seleccionados. <br>
                                                    Hasta agotar stock
                                        ...
                                        <div class="cardFront bgyellowLight borderPurple p1">
                                            <div class="d-flex justify-content-end">
                                                <img src="{{asset('assets/images/ofertas/logo2.png')}}" class="img-card" alt="logo">
                                            </div>
                                            <div class="card-body left green2">
    ...
    <div class="bannerFot">
        <div class="container">
            <a href="#">
                <img src="{{asset('assets/images/ofertas/bamer2.jpg')}}" alt="Banner">
            </a>
        </div>
    </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col">
                        <h2>Suscríbete y recibe <br>más ofertas </h2>
                    </div>
                </div>
                <form id="formSuscription">
                    ...
                    <div class="row row-form">
                        <div class="col">
                            <input type="text" name="movil" id="movil" placeholder="Teléfono"/>
                        </div>
                    </div>
                    <div class="row ">
                        <div class="col-3">
                    ...
                    <div class="row row-form">
                        <div class="col">
                            <p class="meessageRadio"></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="d-flex justify-content-start">
                                <input type="checkbox" name="term" value="si"/>
                                <a href="#" target="_blank">He leído y acepto las políticas de privacidad.</a>
                            </div>
                        </div>
                    </div>
                    <div class="row row-form">
                        <div class="col">
                            <p class="meessageRadio2"></p>
                        </div>
                    </div>
                    <div class="row row-form">
                        <div class="col d-flex justify-content-center">
                            <a href="javascript:void(0)" class="btn btn-light enviarForm">ENVIAR</a>
                        </div>
                    </div>
                </form>
                <div class="agredecimiento">
                    <p>Gracias por suscribirse con nostros</p>
                </div>
            </div>
    ...
    <script src="https://inoutlet.pe/milhorasdelocura/node_modules/bootstrap/dist/js/bootstrap.min.js"></script>
    <script src="https://inoutlet.pe/milhorasdelocura/node_modules/gsap/dist/gsap.js"></script>
    <script src="https://inoutlet.pe/milhorasdelocura/node_modules/gsap/dist/ScrollToPlugin.js"></script>
    <script src="https://inoutlet.pe/milhorasdelocura/node_modules/scrollmagic/scrollmagic/minified/ScrollMagic.min.js"></script>
    <script src="https://inoutlet.pe/milhorasdelocura/node_modules/scrollmagic/scrollmagic/minified/plugins/debug.addIndicators.min.js"></script>
    <script src="https://inoutlet.pe/milhorasdelocura/node_modules/owl.carousel/dist/owl.carousel.min.js"></script>
    <script src="https://inoutlet.pe/milhorasdelocura/node_modules/jquery-validation/dist/jquery.validate.js"></script>
    <script src="https://inoutlet.pe/quinde/assets/js/app.js?v=15"></script>
</body>
</html>
...
@section('meta')
    <title>PROMOCIONES | C.C El Quinde Shopping Plaza Ica</title>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-8 xs-mx-auto xs-center">
                        <div class="container-items-cards container-promotions"></div>
						<button class="btn btn--theme3 mt-4" id="view_more_promotions" type="button">VER MÁS PROMOCIONES</button>
                    </div>
                </div>
            </div>
        </section>

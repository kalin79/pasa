...
@section('meta')
    <title>Términos y Condiciones :: Ica | C.C El Quinde Shopping Plaza Ica</title>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-5 col-lg-3">
                        <div class="box-ul">
                            <ul>
                                <li>
                                    <a href="/ica/terminos-condiciones">POLÍTICA DE PRIVACIDAD > </a>
                                </li>
                                <li>
                                    <a href="javascript:vod(0)" style="cursor:none">LEGALES DE CAMPAÑA</i></a>
                                    <select id="cbx-campanas">
                                        <option value="/ica/terminos-condiciones/">Seleccionar </option>
                                        <option value="/ica/terminos-condiciones/milhorasdelocura">1000 HORAS DE LOCURA</option>
                    ...
                    <?php if ( (isset($_camp)) && ($_camp == 'milhorasdelocura')) { ?>
                        <div class="col-xs-12 col-sm-7 col-lg-9">
                            ...
                            <div class="description">
                                ...
                                Para ver descuentos ingresar a: <a href="https://www.elquinde.pe/ica/milhorasdelocura">www.elquinde.pe/ica/milhorasdelocura</a>

...
@section('meta')
    <title>CARTELERA | C.C El Quinde Shopping Plaza Ica</title>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-10 xs-mx-auto xs-center">
                        <div class="row container-billboards"></div>
                        <button class="btn btn--theme3 mt-4" id="view_more_billboards" type="button">
                            VER MÁS CARTELERA
                        </button>
                    </div>
                </div>

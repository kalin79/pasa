...
@section('meta')
    ...
    <title>{{$tienda->nombre}} | C.C El Quinde Shopping Plaza Ica</title>
                ...
                <div class="container">
                    <div class="content-stores-intermal pt-5">
                        <div class="stores-intermal-title">
                            <div id="title-store"><a href="{{url('ica/tiendas')}}">TIENDAS</a><span id="subTitle-store"> > {{$tienda->nombre}}</span></div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="text-center mt-5 mb-lg-0"><a class="btn--back mb-5" href="{{url('ica/tiendas')}}">Volver al listado</a></div>
                    </div>
                </div>
            </section>

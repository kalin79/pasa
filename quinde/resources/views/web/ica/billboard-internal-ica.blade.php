...
@section('meta')
  ...
  <title>{{$cartelera->titulo}} | C.C El Quinde Shopping Plaza Ica</title>
          ...
          <div class="col-lg-10 xs-mx-auto">
            <div class="row">
              <div class="col-12 mb-4">
                <div class="breadcrumb"><a href="{{url('ica/carteleras')}}">CARTELERA</a> > <span class="text-breadcrumb" id="title_breadcrumb">{{$cartelera->titulo}}</span></div>
              </div>
            </div>
            ...
            <div class="row mt-5">
              <div class="col-12 mt-5 xs-center"><a class="btn btn--theme3" href="{{url('ica/carteleras')}}">Volver</a></div>
            </div>
          </div>
        </div>
      </div>

...
<head>
	...
	})(window,document,'script','dataLayer','GTM-PQGSRFH');</script>
	...
	<link rel="stylesheet" href="{{asset('assets/lib/css/font-awesome.5.0.13.all.css')}}">
	<link href="{{asset('assets/css/main.0f39fc1.bundle.css?0f39fc1c10353f1a03ac')}}" rel="stylesheet">
	<script type='application/ld+json'>
	  {"@context":"http:\/\/schema.org",
		"@type":"WebSite",
		"@id":"#website",
		"url":"http:\/\/www.elquinde.pe",
		"name":"C.C El Quinde Shopping Plaza Cajamarca",
		"potentialAction":{
		  "@type":"SearchAction",
		  "target":"http:\/\/www.elquinde.pe?s={search_term_string}",
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PQGSRFH"
...
<header class="header">
	<nav class="navbar" id="navbar">
		<div class="container navbar-container">
			<div class="navbar-brand"><a href="{{url('cajamarca')}}"><img class="logo" src="{{asset('assets/images/logo.png')}}"></a></div>
			<div class="navbar-search navbar-search-toggle">
				<div class="form-search"><a class="btn btn--color9 mb-2 lg-none-force" href="{{url('cajamarca/suscripcion')}}">SUSCRÍBETE</a>
				...
				<div class="buttons-content"><a class="btn btn--theme" href="{{url('cajamarca/suscripcion')}}">SUSCRÍBETE</a></div>
			</div>
			<div class="navbar-menu">
				<div class="content-menu">
					<ul class="menu menu-fix-toggle">
						<li class="menu__item"><a class="menu__link link-about {{ request()->is('cajamarca/nosotros') ? 'active' : '' }}" href="{{url('cajamarca/nosotros')}}">Nosotros</a></li>
						<li class="menu__item"><a class="menu__link link-stores {{ request()->is('cajamarca/tiendas') || request()->is('cajamarca/tiendas/*') ? 'active' : '' }}" href="{{url('cajamarca/tiendas')}}">Tiendas</a></li>
						<li class="menu__item"><a class="menu__link link-promotions {{ request()->is('cajamarca/promociones') ? 'active' : '' }}" href="{{url('cajamarca/promociones')}}">Promociones</a></li>
						<li class="menu__item"><a class="menu__link link-events {{ request()->is('cajamarca/eventos') ? 'active' : '' }}" href="{{url('cajamarca/eventos')}}">Eventos</a></li>
						<li class="menu__item not-border-right"><a class="menu__link link-billboard {{ request()->is('cajamarca/carteleras') ? 'active' : '' }}" href="{{url('cajamarca/carteleras')}}">Cartelera</a></li>
					</ul>
				</div>
			</div>
				...
				<div class="container xs-center">
					<ul class="menu-movil">
						<li>
							<ul class="menu-location">
								<li class="menu-location__item"><a class="menu-location__link {{ request()->is('ica') || request()->is('ica/*') ? 'active' : '' }}" href="{{url('ica')}}">Ica</a></li>
								<li class="menu-location__item"><a class="menu-location__link active {{ request()->is('cajamarca') || request()->is('cajamarca/*') ? 'active' : '' }}" href="{{url('cajamarca')}}">Cajamarca</a></li>
							</ul>
						</li>
						<li>
							<div class="form-search"><a class="btn btn--color9 mb-3 lg-none-force" href="{{url('cajamarca/suscripcion')}}">SUSCRÍBETE</a>
								<div class="content-input">
						...
						<li>
							<ul class="nav-movil">
								...
								<li class="menu__item"><a class="menu__link link-events {{ request()->is('cajamarca/eventos') ? 'active' : '' }}" href="{{url('cajamarca/eventos')}}">Eventos</a></li>
								<li class="menu__item not-border-right"><a class="menu__link link-billboard {{ request()->is('cajamarca/carteleras') ? 'active' : '' }}" href="{{url('cajamarca/carteleras')}}">Cartelera</a></li>
								<li class="menu__item not-border-right"><a class="menu__link link-billboard {{ request()->is('cajamarca/terminos-condiciones') ? 'active' : '' }}" href="{{url('cajamarca/terminos-condiciones')}}">Términos y Condiciones</a></li>
							</ul>
						</li>
					</ul>
				</div>
...
<div class="container-search-full" id="container_search_full"><a class="close-search-full" id="close_search_full" href="#"></a>
	<div class="container">
		<div class="container-form">
			<form class="form">
				<div class="autocomplete-wrapper"><input class="form-control" id="input_search_full" type="text" value="" placeholder="Carteleras, Eventos, Promociones, Tiendas..." autocomplete="off"><span class="fa fa-search"></span></div>
			</form>
		</div>
	...
	<div class="container">
		<div class="row footer-main">
			...
			<div class="col-md-4 col-lg-3 col-xxxl-4">
				<div class="footer__menu">
					<ul class="menu-footer">
						<li class="menu-footer__item"><a class="menu-footer__link {{ request()->is('cajamarca') ? 'active' : '' }}" href="{{url('cajamarca')}}">Home</a></li>
						<li class="menu-footer__item"><a class="menu-footer__link {{ request()->is('cajamarca/nosotros') ? 'active' : '' }}" href="{{url('cajamarca/nosotros')}}">Nosotros</a></li>
						<li class="menu-footer__item"><a class="menu-footer__link {{ request()->is('cajamarca/tiendas') || request()->is('cajamarca/tiendas/*') ? 'active' : '' }}" href="{{url('cajamarca/tiendas')}}">Tiendas</a></li>
					</ul>
					<ul class="menu-footer ml-4">
						<li class="menu-footer__item"><a class="menu-footer__link {{ request()->is('cajamarca/promociones') ? 'active' : '' }}" href="{{url('cajamarca/promociones')}}">Promociones</a></li>
						<li class="menu-footer__item"><a class="menu-footer__link {{ request()->is('cajamarca/eventos') ? 'active' : '' }}" href="{{url('cajamarca/eventos')}}">Eventos</a></li>
						<li class="menu-footer__item"><a class="menu-footer__link {{ request()->is('cajamarca/carteleras') ? 'active' : '' }}" href="{{url('cajamarca/carteleras')}}">Cartelera</a></li>
						<li class="menu-footer__item"><a class="menu-footer__link {{ request()->is('cajamarca/terminos-condiciones') ? 'active' : '' }}" href="{{url('cajamarca/terminos-condiciones')}}">Términos y Condiciones</a></li>
					</ul>
				</div>
				<div class="footer__menu mt-3">
					<ul class="menu-footer">
						<li class="menu-footer__item xs-center"><a class="btn btn--color3 mb-4 xs-block-force md-none-force" href="{{url('/cajamarca/abrir_tienda')}}">ABRE UNA TIENDA CON NOSOTROS</a>
			...
			<div class="col-lg-4 col-xxxl-3 footer__social mt-4 mt-lg-0 xs-center">
				<ul class="menu-social" id="menu-social"></ul><a class="btn btn--color3 mt-4 xs-none-force md-i-block-force" href="{{url('/cajamarca/abrir_tienda')}}">ABRE UNA TIENDA CON NOSOTROS</a>
			</div>
		</div>
	</div>
</footer>

		...
		<div class="about">
			<div class="container">
				<div class="content_info d-flex justify-content-between">
					<div>
						<h5><b class="text-uppercase">ica</b> / Nosotros</h5>
					</div>
				</div>
			</div>
				...
				<div class="container">
					...
					<div class="content-data-about">
						...
						<form class="form" id="form_about_horarios">
							<div class="row">
								<div class="col-xl-8">
									<div class="form-group"><label class="color1 label-theme">Horario de Atención:</label><textarea class="form-control w-100" id="horario_de_atencion" cols="30" rows="5"></textarea></div>
								</div>
							</div>
						</form>
					</div>

...
<meta name="data_tienda" content="7">
@endsection
    ...
    <main class="main  ">
        <div class="container">
            <div class="content_info d-flex justify-content-between">
                <div>
                    <h5><b class="text-uppercase">ica</b> / Home - Promociones</h5>
                </div>
                <div>
                    <div class="link__new" onclick="addPromotions()">Nuevo &nbsp;<i class="fa fa-plus"></i></div>
                </div>
            </div>
            <form id="formRangoFechas" action=""><input type="hidden" name="ciudad" value="ica">
                <div class="content_info content_info_fechas">
                    <div>
                        <h5>Mostrando en la web</h5>
                    </div>
                    <div><label for="">Desde: &nbsp;<input type="text" name="fecha_ini" id="fechaIniHome"><label class="messages error d-none" id="error-fecha-1" for="">.</label></label><label for="">Hasta: &nbsp;<input type="text" name="fecha_fin" id="fechaFinHome"><label class="messages error d-none" id="error-fecha-2" for="">Esta decha no puede ser menor a la fecha de inicio</label></label></div>
